...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("app/icons/update.jpg"));
        id15.setIcon(img);
        
        id8 = new JLabel("New Employee Details");
        id8.setBounds(260,30,500,50);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"')";  //(name, fname, age, dob, address, phone, email, education, post, aadhar, emp_id) 
